...
public class BlockTileEntityTWB extends BlockContainer
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityLiving, ItemStack itemStack)
    {
        ...
        if (world.getTileEntity(x, y, z) instanceof TileEntityTWB)
        {
            int direction = 0;
            ...
            {
                ((TileEntityTWB) world.getTileEntity(x, y, z)).setCustomName(itemStack.getDisplayName());
            }

            ((TileEntityTWB) world.getTileEntity(x, y, z)).setOrientation(direction);
        }
    }
